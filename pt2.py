                ...
                if checklist_files:
                    ...
                    for checklist_file in checklist_files:
                        try:
                            ...
                            print(f"   ⚠ Error reading {os.path.basename(checklist_file)}: {e}")
...
def create_ca_visualization_by_vague(dest_dir, graph_dir):
    ...
    try:
        ...
        # Add explanatory text annotations on the right side
        annotation_x = 0.76  # Position on the right side
        annotation_y_start = 0.65
        line_spacing = 0.13
